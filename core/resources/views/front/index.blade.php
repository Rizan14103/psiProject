...
<div class="banner-slide">
    ...
    <div class="banner-area bg_cover d-flex align-items-center"
        style="background-image: url({{$slider->bg_image ? asset('assets/front/img/sliders/bg_image/'.$slider->bg_image) : ''}})">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-7">
                    <div class="banner-content">
                        <h1 data-animation="fadeInUp" data-delay="1s" class="title"
                            style="color: #{{$slider->title_color}};">{{convertUtf8($slider->title)}}</h1>
                        <p data-animation="fadeInUp" data-delay="1.3s" style="color: #{{$slider->text_color}};">
                            {{convertUtf8($slider->text)}}</p>
                        <ul data-animation="fadeInUp" data-delay="1.6s">
                            @if($slider->button_text && $slider->button_url)
                            <li><a style="color:#{{$slider->button_color}};border: 2px solid #{{$slider->button_color}};"
                                    class="main-btn"
                                    href="{{$slider->button_url}}">{{convertUtf8($slider->button_text)}} </a></li>
                            @endif
                            @if($slider->button_text1 && $slider->button_url1)
                            <li><a class="main-btn main-btn-2"
                                    href="{{$slider->button_url1}}">{{convertUtf8($slider->button_text1)}} </a></li>
                            @endif
...
<section class="experience-area">
    <div class="container">
        <div class="row justify-content-center justify-content-lg-end">
            <div class="col-lg-6 col-md-8">
                <div class="experience-content">
                    ...
                    @endif
                    <h3 class="title wow fadeIn animated" data-wow-duration="2000ms" data-wow-delay="0ms">
                        {{convertUtf8($bs->intro_title)}}</h3>
                    <p class=" wow fadeIn animated" data-wow-duration="2000ms" data-wow-delay="300ms">
                    ...
                    <img class=" wow fadeIn animated" data-wow-duration="2000ms" data-wow-delay="600ms"
                        src="{{asset('assets/front/img/'.$bs->intro_signature)}}" alt="autograph">
                    @endif
        ...
        <div class="row align-items-end">
            ...
            <div class="col-lg-7">
                <div class="experience-play-item mt-70 wow fadeIn animated" data-wow-duration="2000ms"
                    ...
                    <ul class="nav nav-pills d-flex justify-content-center" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{$keys == 0 ? 'active' : ''}}" id="{{$category->slug}}-tab"
                                ...
                                @php
                                $path = str_replace ( 'core' , '' , base_path() ) . 'assets/front/img/category/' .
                                $category->image;
                                @endphp
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade {{$key == 0 ? 'show active' : ''}}" id="{{$category->slug}}"
                        ...
                        <div class="row justify-content-center">
                            ...
                            @foreach ($category->products()->where('is_feature', 1)->where('status', 1)->get() as
                            $product)
                            <div class="col-lg-6">
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="tabs-btn pb-20">
                    <ul class="nav nav-pills d-flex justify-content-center" id="pills-tab" role="tablist">
                        @foreach ($categories as $keys => $category)
                        <li class="nav-item">
                            <a class="nav-link {{$keys == 0 ? 'active' : ''}}" id="{{convertUtf8($category->slug)}}-tab"
                                data-toggle="pill" href="#{{convertUtf8($category->slug)}}" role="tab"
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="tab-content" id="pills-tabContent">
                    @foreach ($categories as $key => $category)
                    <div class="tab-pane fade {{$key == 0 ? 'show active' : ''}}" id="{{convertUtf8($category->slug)}}"
                        role="tabpanel" aria-labelledby="{{convertUtf8($category->slug)}}-tab">
                            ...
                            <div class="single-menu-item mt-30">
                                <div class="menu-thumb">
                                    <img src="{{asset('assets/front/img/product/featured/'.$product->feature_image)}}"
                                        alt="menu">
                                    <div class="thumb-overlay">
                                        <a href="{{route('front.product.details',[$product->slug,$product->id])}}"><i
                                                class="flaticon-add"></i></a>
                                    </div>
                                </div>
                                <div class="menu-content ml-30">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-8">
                <div class="special-items">
                    ...
                    <div class="good-food-item white-bg text-center wow fadeIn animated" data-wow-duration="2000ms"
                        data-wow-delay="0ms">
                        <div class="food-shape">
                            <img class="food-shape-img" src="{{asset('assets/front/img/good-food-shape.png')}}"
                                alt="shape">
                        </div>
                        <h3 class="title">
...
<section class="client-area bg_cover pt-105 pb-95"
    style="background-image: url({{$be->testimonial_bg_img ? asset('assets/front/img/'.$be->testimonial_bg_img) : ''}})">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
...
<section class="reservation-area bg_cover">
    <div id="map">
        ...
        <iframe class="border-0"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15816.09607037925!2d110.41430395!3d-7.68056635!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a5f2453927085%3A0x2ed34ddad1b94c1f!2sUII%20Yogyakarta!5e0!3m2!1sid!2sid!4v1655264030890!5m2!1sid!2sid"
            width="600" height="450" style="border:0;" allowfullscreen="allowfullscreen"></iframe>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-9 col-sm-10">
                <div class="reservation-item white-bg text-center pt-100 pb-50">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="section-title text-center">
                                <span>{{convertUtf8($be->table_section_title)}} <img
                                        src="{{asset('assets/front/img/title-icon.png')}}" alt=""></span>
                    ...
                    <div class="book-table">
                        <form action="{{route('front.table.book')}}" id="bookTable" method="POST">
                            ...
                            <div class="input-box mt-20">
                                <input type="text" id="datepicker" placeholder="{{__('Date')}}" name="date"
                                    autocomplete="off">
                                @error('date')
                                <p class="text-danger">{{convertUtf8($message)}}</p>
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="input-box mt-20">
                                        <input type="text" placeholder="{{__('Time')}}" class="timepicker" name="time"
                                            autocomplete="off">
                                        @error('time')
                                        <p class="text-danger">{{convertUtf8($message)}}</p>
                                        @enderror
